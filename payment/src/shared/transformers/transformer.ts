...
export interface AbilityIncludePermissions {
  includePermissions(model: IPermissions);
}
...
export interface TransformerInterface {
   ...
   * @return Entity
   */
  item(entity: Entity, transformer: TransformerInterface): Entity;
   ...
   * @return Collection
   */
  collection(collection: Entity[], transformer: TransformerInterface): Entity[];
...
export abstract class Transformer implements TransformerInterface {
  ...
  abstract transform(model: Entity);
