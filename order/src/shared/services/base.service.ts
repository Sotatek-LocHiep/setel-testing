import { Repository, getManager, SelectQueryBuilder, FindManyOptions, FindOneOptions, FindConditions } from 'typeorm';
...
export class BaseService {
  ...
  async paginate(
    query_builder: Repository<any> | SelectQueryBuilder<any> | null,
    options: any /**IPaginationOptions */,
  ...
  async findWhere(condition: FindConditions<any>, columns: string[] | null = null): Promise<any> {
    return this.repository.find({
      where: condition,
      select: columns,
    });
